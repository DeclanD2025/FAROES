...
export default function TransportPage() {
  return <article className="px-6 sm:px-8 lg:px-12 pt-10 pb-20 max-w-[72rem]">
    ...
    <aside className="mt-7 max-w-[60rem] border-l-4 border-rust bg-rust/[.04] px-5 py-4"><p className="label text-rust">Audit outcome</p><p className="mt-1 text-[14px] text-basalt">Wednesday remains on Suðuroy. Friday’s former 11:30 northbound ferry is removed: SSL publishes 07:00 and 16:00 Friday departures. Monday airport-to-ferry and Friday Tórshavn-to-Sørvágur connections require human confirmation.</p></aside>
