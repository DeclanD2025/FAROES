...
export default function BookingsPage() {
  return <article className="px-6 sm:px-8 lg:px-12 pt-10 pb-20 max-w-[68rem]">
    ...
    <section className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-3"><Metric value="3" label="Confirmed from booking" /><Metric value="2" label="Verified route services" /><Metric value="1" label="Friday chain to resolve" /></section>
