...
const CHECKLIST_ITEMS = [
  ...
  { id: "bd-gist-arrival", group: "Save", what: "Gist arrival note saved offline", why: "Late arrival ~23:30. Host Arnbjørn says the key will be in the door; look for the Gist sign above the entrance.", deadline: "Day 1", relatedDay: "1" },
  ...
  { id: "bd-accommodation-confirm", group: "Confirm", what: "Both accommodation confirmations saved offline", why: "Gist Øravík Airbnb + Guesthouse Hugo. Save the Gist arrival note and Hugo PIN separately.", deadline: "Before departure", relatedDay: "1,5" },
