...
export function ConnectivityGuide() {
  ...
  return (
    <article className="px-4 sm:px-8 lg:px-12 pt-8 pb-24 max-w-[1060px]">
      ...
      <p className="mt-7 pt-4 border-t border-basalt/10 text-[11px] leading-[1.5] text-basalt/45">Verified {CONNECTIVITY_PLAN.checkedAt}: <a className="underline underline-offset-2" href={CONNECTIVITY_PLAN.purchaseUrl} target="_blank" rel="noreferrer">Nomad Faroe Islands plan</a> · <a className="underline underline-offset-2" href="https://help.giffgaff.com/en/articles/229548-using-your-mobile-phone-in-the-rest-of-the-world" target="_blank" rel="noreferrer">giffgaff international-roaming guidance</a>.</p>
    </article>
  );
}
