...
export const CRITICAL_TRANSPORT: TransportLeg[] = [
  {
    ...
    arrival: "~16:35",
    duration: "2h 05m",
    leaveBy: "Arrive at the terminal by 13:30; foot-passenger gate closes 14:25",
    confidence: "Verified from official source",
    action: "Pre-book the Øravík → Krambatangi taxi for an early-afternoon arrival, save the ferry booking offline and join the foot-passenger queue. This is the last northbound Ólavsøka sailing.",
    fallback: "If this sailing is missed or cancelled, remain on Suðuroy and use the local fallback plan. The next special sailing is southbound, not northbound.",
  },
  {
    id: "olavsoka-south",
    date: "Wed 29 Jul",
...
export const DAY_OPERATIONS = [
  ...
  },
  {
    ...
    chapter: "Ólavsøka",
    briefing: "Take the afternoon Smyril to Tórshavn for the evening of Ólavsøka; protect the 21:15 return.",
    carry: ["ferry booking", "charged power bank", "water and food", "waterproof and warm layer", "cash/card"],
    actions: [
      ["13:15 · taxi to Krambatangi", "Use the pre-booked Øravík transfer. Aim to be at the terminal by 13:30; this is an Ólavsøka sailing, so do not rely on a last-minute local bus."],
      ["14:30 · Smyril northbound", "Route 7 sails to Tórshavn (about 2h 05m). Keep the booking ready; the foot-passenger gate closes at 14:25."],
      ["~16:35 · Tórshavn", "Walk into the centre and use the live programme on Tímin to choose between exhibitions, food, music and the evening festival atmosphere. Road closures shift during the day."],
      ["Late afternoon · festival rhythm", "Use the harbour, Tinganes, food stalls, music and chain dancing as the day unfolds. The 29th is a holiday: treat shops as closed unless you have confirmed otherwise."],
    ...
    risk: "The 14:30 northbound ferry is the last published special Route 7 sailing to Tórshavn on Ólavsøka Day. Festival crowds and weather make a 13:30 terminal arrival and a strict evening exit essential.",
  },
  {
    number: 4,
