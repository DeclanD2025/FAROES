...
export const CRITICAL_TRANSPORT: TransportLeg[] = [
  {
    id: "olavsoka-north",
    date: "Wed 29 Jul",
    title: "Krambatangi → Tórshavn · choose an Ólavsøka sailing",
    operator: "Strandfaraskip Landsins",
    service: "Route 7 · M/F Smyril · special Ólavsøka sailing",
    departure: "07:00 or 14:30",
    arrival: "~09:05 or ~16:35",
    duration: "2h 05m",
    leaveBy: "07:00: terminal by 06:00 · 14:30: terminal by 13:30",
    confidence: "Verified from official source",
    action: "Choose the full-day 07:00 crossing or the compact-evening 14:30 crossing, then pre-book the Øravík → Krambatangi taxi to match. Save the ferry booking offline and join the foot-passenger queue.",
    fallback: "If the selected sailing is missed or cancelled, remain on Suðuroy and use the local fallback plan. The next special sailing is southbound, not northbound.",
  },
  {
    id: "olavsoka-south",
    date: "Wed 29 Jul",
...
export const DAY_OPERATIONS = [
  ...
  },
  {
    ...
    base: "Øravík → Krambatangi → Tórshavn → Øravík · choose 07:00 or 14:30 outbound",
    chapter: "Ólavsøka",
    briefing: "Choose a full day in Tórshavn or a compact evening visit, then protect the 21:15 return.",
    carry: ["ferry booking", "charged power bank", "water and food", "waterproof and warm layer", "cash/card"],
    actions: [
      ["Choose your departure", "07:00 arrives around 09:05 and gives the full national day; 14:30 arrives around 16:35 and gives a compact Ólavsøka evening. Both return on the 21:15 Smyril."],
      ["07:00 option · full day", "Pre-book the Øravík taxi to reach Krambatangi by 06:00; the foot-passenger gate closes at 06:55. Use the morning for the official programme, then take the festival at an easy pace."],
      ["14:30 option · evening", "Pre-book the Øravík taxi to reach Krambatangi by 13:30; the foot-passenger gate closes at 14:25. Arrive around 16:35 for food, music and the evening atmosphere."],
      ["In Tórshavn", "Use the harbour, Tinganes, food stalls, music and chain dancing as the day unfolds. The 29th is a holiday: treat shops as closed unless you have confirmed otherwise."],
    ...
    risk: "Both published northbound Ólavsøka sailings return only on the 21:15 ferry. Festival crowds and weather make the selected terminal arrival time—and a strict 20:20 evening exit—essential.",
  },
  {
    number: 4,
