...
export const DAY_OPERATIONS = [
  ...
  },
  {
    ...
    actions: [
      ["08:30 · weather and services", "Check visibility, wind and SSL’s Ólavsøka notices. Route 700 has special services and request-only rules; do not set off on a timetable remembered from another day."],
      ["Late morning · local Suðuroy", "Use Øravík/Tvøroyri for a low-commitment day: harbour, church and a short local walk only if weather supports it. Do not build Wednesday around an unsupported Tórshavn ferry plan."],
      ["Early afternoon · resupply", "In Tvøroyri, buy Thursday breakfast, water, ferry snacks and any medication or plasters. Øravík has no proper supermarket; Krambatangi has only basic terminal facilities."],
      ["18:00 · match-day lock-in", "Pack ticket/accreditation, ferry record, power bank, waterproof layer and overnight essentials. Pre-book Øravík/Krambatangi taxi and confirm Thursday foot-passenger reservation."],
    ],
