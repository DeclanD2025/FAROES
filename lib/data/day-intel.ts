...
export const ORAVIK_BASE_GUIDE: DistanceBand[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "tvor-hospital",
        name: "Suðuroyar Sjúkrahús",
        category: "medical",
        distanceKm: 3.5,
        walkingTimeMin: 45,
        busRoute: "700",
        busStops: 2,
        openingHours: "24/7 A&E — call 112 for emergencies",
        notes: "The hospital for Suðuroy. Emergency department open 24/7. Non-emergency: call daytime for appointments. Located in Tvøroyri, near the pharmacy.",
        confidence: "confirmed",
        fallback: "Call 112. Air ambulance to Tórshavn if required.",
      },
      {
        id: "tvor-taxi",
        name: "Suðuroy Taxi",
        ...
        busRoute: null,
        busStops: null,
        openingHours: "24/7 — pre-book for late arrivals",
        notes: "Pre-book for late-night Krambatangi arrivals (~DKK 150 to Øravík, 5 min). Also useful for Beinisvørð (~DKK 400–500 return). Call +298 239550. Save the number before you lose signal.",
        confidence: "confirmed",
        fallback: "Bus 700 for most routes. Walking is the last resort.",
      },
      {
        id: "tvor-atm",
